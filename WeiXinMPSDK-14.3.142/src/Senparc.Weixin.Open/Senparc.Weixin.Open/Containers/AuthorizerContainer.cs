...
namespace Senparc.Weixin.Open.Containers
{
    ...
    public class AuthorizerBag : BaseContainerBag
    {
        ...
        public DateTime JsApiTicketExpireTime
        {
            ...
            set { _jsApiTicketExpireTime = value; }
        }
        ...
        public DateTime AuthorizationInfoExpireTime
        {
            ...
            set { _authorizationInfoExpireTime = value; }
        }
    ...
    public class AuthorizerContainer : BaseContainer<AuthorizerBag>
    {
            ...
            bool getNewTicket = false)
        {
            ...
            using (Cache.BeginCacheLock(LockResourceName + ".GetAuthorizationInfo", authorizerAppid))//同步锁
            {
                ...
                if (getNewTicket || authorizerBag.AuthorizationInfoExpireTime <= DateTime.Now)
                {
                    ...
                    authorizerBag.AuthorizationInfo.authorizer_access_token = refreshResult.authorizer_access_token; ;
                    authorizerBag.AuthorizationInfo.authorizer_refresh_token = refreshResult.authorizer_refresh_token;
                    authorizerBag.AuthorizationInfo.expires_in = refreshResult.expires_in;
                    authorizerBag.AuthorizationInfoExpireTime = ApiUtility.GetExpireTime(refreshResult.expires_in);
        ...
        public static void TryUpdateAuthorizationInfo(string componentAppId, string authorizerAppid, string authorizerAccessToken, string authorizerRefreshToken, int expiresIn)
        {
            ...
            if (expiresIn > 0 && authorizerAccessToken != null)
            {
                ...
                if (refreshTokenChanged)
                {
                    Update(authorizerAppid, authorizerBag);
                    ComponentContainer.AuthorizerTokenRefreshedFunc(authorizerAppid,
